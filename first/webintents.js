...
(function () {
    ...
    const INTENTS_SERVER = 'http://webintents.yun.com'
    ...
    Intents.prototype.startActivity = function (intent, onResult, onFailure) {
        ...
        var params = "directories=no,menubar=no,status=0,location=0,fullscreen=no,width=800,height=500";
        ...
        window.open(pickerSource, encodeNameTransport(intent), params);
        //
        if (onResult) {
